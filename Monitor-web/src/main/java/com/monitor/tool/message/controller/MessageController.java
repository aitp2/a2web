package com.monitor.tool.message.controller;

import com.monitor.framework.base.pojo.Result;
import com.monitor.framework.message.SimpleMailSender;
import com.monitor.framework.message.entity.SimpleMail;
import com.monitor.framework.utils.PropertiesUtil;
import com.monitor.tool.message.service.MessageService;
