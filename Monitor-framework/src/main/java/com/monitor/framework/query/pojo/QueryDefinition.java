package com.monitor.framework.query.pojo;

import com.monitor.framework.query.entity.Query;
import com.monitor.framework.query.entity.QueryContext;
import com.monitor.framework.utils.ConfigurationUtil;
            ...
            for (int i = 0; i < resources.length; i++) {
                ...
                try {
                    QueryContext queryContext = (QueryContext) ConfigurationUtil.parseXMLObject(
                            com.monitor.framework.query.entity.QueryContext.class, resource);
